                ...
                <div className='about-content' data-aos="fade-up">
                    ...
                    <div className='about-section'>
                        <h3>What Sets Us Apart?</h3>
                            ...
                            <ul>
                                <li data-aos="fade-right"><i className='fa-solid fa-circle-check'></i><strong>Fast Response Times:</strong> When you call, we're ready. Our tow trucks are located to ensure minimal wait times.</li>
                                <li data-aos="fade-right"><i className='fa-solid fa-circle-check'></i><strong>24/7 Availability:</strong> No matter the time of day or night, we're here to help.</li>
                                <li data-aos="fade-right"><i className='fa-solid fa-circle-check'></i><strong>Skilled Professionals:</strong> Our team of licesned and trained drivers ensures your vehicle is handled with care.</li>
                                <li data-aos="fade-right">See the services we provide here: <Link to="/Services">Services</Link></li>
                            </ul>
